  ...
  return SliverAppBar(
    ...
    actions: [
      Container(
          ...
          child: heartButton(controller: controller, propertyId: property.id))
    ],
    backgroundColor: Colors.transparent,
    elevation: 0, // No shadow
    expandedHeight: 250.0, // Height of the app bar when expanded
    floating: true,
    pinned: true, // Keeps the app bar pinned at the top after collapsing
    flexibleSpace: FlexibleSpaceBar(
      background: Stack(
        ...
        children: [
          ...
          Container(
            color: Colors.black
                .withOpacity(0.3), // Dark overlay for better text visibility
          ),
        ],
      ),
    ),
